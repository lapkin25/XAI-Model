...
df.loc[(df['Age'] >= 70), ('F1')] = 1
df.loc[(df['Age'] < 70), ('F1')] = 0

df.loc[(df['HR'] >= 82), ('F2')] = 1
df.loc[(df['HR'] < 82), ('F2')] = 0

df.loc[(df['Killip class'] >= 3), ('F3')] = 1
df.loc[(df['Killip class'] < 3), ('F3')] = 0

df.loc[(df['Cr'] >= 135.7), ('F4')] = 1
df.loc[(df['Cr'] < 135.7), ('F4')] = 0

df.loc[(df['EF LV'] <= 45.0), ('F5')] = 1
df.loc[(df['EF LV'] > 45.0), ('F5')] = 0

df.loc[(df['NEUT'] >= 75.6), ('F6')] = 1
df.loc[(df['NEUT'] < 75.6), ('F6')] = 0

df.loc[(df['EOS'] <= 0.48), ('F7')] = 1
df.loc[(df['EOS'] > 0.48), ('F7')] = 0

df.loc[(df['PCT'] >= 0.24), ('F8')] = 1
df.loc[(df['PCT'] < 0.24), ('F8')] = 0

df.loc[(df['Glu'] >= 6.83), ('F9')] = 1
df.loc[(df['Glu'] < 6.83), ('F9')] = 0

df.loc[(df['SBP'] <= 115.0), ('F10')] = 1
df.loc[(df['SBP'] > 115.0), ('F10')] = 0

df.loc[(df['EOS'] <= 0.48) & (df['NEUT'] >= 75.6), ('F11')] = 1
df.loc[(df['EOS'] > 0.48) | (df['NEUT'] < 75.6), ('F11')] = 0

df.loc[(df['Age'] >= 70) & (df['NEUT'] >= 75.6), ('F12')] = 1
df.loc[(df['Age'] < 70) | (df['NEUT'] < 75.6), ('F12')] = 0

df.loc[(df['Age'] >= 70) & (df['Glu'] >= 6.83), ('F13')] = 1
df.loc[(df['Age'] < 70) | (df['Glu'] < 6.83), ('F13')] = 0

df.loc[(df['HR'] >= 82) & (df['Killip class'] >= 3), ('F14')] = 1
df.loc[(df['HR'] < 82) | (df['Killip class'] < 3), ('F14')] = 0

df.loc[(df['HR'] >= 82) & (df['EOS'] <= 0.48), ('F15')] = 1
df.loc[(df['HR'] < 82) | (df['EOS'] > 0.48), ('F15')] = 0

df.loc[(df['Killip class'] >= 3) & (df['Cr'] >= 135.7), ('F16')] = 1
df.loc[(df['Killip class'] < 3) | (df['Cr'] < 135.7), ('F16')] = 0

df.loc[(df['Killip class'] >= 3) & (df['EF LV'] <= 45.0), ('F17')] = 1
df.loc[(df['Killip class'] < 3) | (df['EF LV'] > 45.0), ('F17')] = 0

df.loc[(df['Killip class'] >= 3) & (df['NEUT'] >= 75.6), ('F18')] = 1
df.loc[(df['Killip class'] < 3) | (df['NEUT'] < 75.6), ('F18')] = 0

df.loc[(df['Killip class'] >= 3) & (df['PCT'] >= 0.24), ('F19')] = 1
df.loc[(df['Killip class'] < 3) | (df['PCT'] < 0.24), ('F19')] = 0

df.loc[(df['Killip class'] >= 3) & (df['Glu'] >= 6.83), ('F20')] = 1
df.loc[(df['Killip class'] < 3) | (df['Glu'] < 6.83), ('F20')] = 0

df.loc[(df['Killip class'] >= 3) & (df['SBP'] <= 115.0), ('F21')] = 1
df.loc[(df['Killip class'] < 3) | (df['SBP'] > 115.0), ('F21')] = 0

df.loc[(df['Cr'] >= 135.7) & (df['EF LV'] <= 45.0), ('F22')] = 1
df.loc[(df['Cr'] < 135.7) | (df['EF LV'] > 45.0), ('F22')] = 0

df.loc[(df['Cr'] >= 135.7) & (df['NEUT'] >= 75.6), ('F23')] = 1
df.loc[(df['Cr'] < 135.7) | (df['NEUT'] < 75.6), ('F23')] = 0

df.loc[(df['Cr'] >= 135.7) & (df['EOS'] <= 0.48), ('F24')] = 1
df.loc[(df['Cr'] < 135.7) | (df['EOS'] > 0.48), ('F24')] = 0

df.loc[(df['Cr'] >= 135.7) & (df['SBP'] <= 115.0), ('F25')] = 1
df.loc[(df['Cr'] < 135.7) | (df['SBP'] > 115.0), ('F25')] = 0

df.loc[(df['EF LV'] <= 45.0) & (df['SBP'] <= 115.0), ('F26')] = 1
df.loc[(df['EF LV'] > 45.0) | (df['SBP'] > 115.0), ('F26')] = 0

df.loc[(df['NEUT'] >= 75.6) & (df['SBP'] <= 115.0), ('F27')] = 1
df.loc[(df['NEUT'] < 75.6) | (df['SBP'] > 115.0), ('F27')] = 0

df.loc[(df['EOS'] <= 0.48) & (df['Glu'] >= 6.83), ('F28')] = 1
df.loc[(df['EOS'] > 0.48) | (df['Glu'] < 6.83), ('F28')] = 0
