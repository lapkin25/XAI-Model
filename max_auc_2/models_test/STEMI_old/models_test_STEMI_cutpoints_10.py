...
df.loc[(df['интервал PQ 120-200'] >= 218.9604) & ((df['RR 600-1200'] <= 543.48734)), ('F9')] = 1
df.loc[(df['интервал PQ 120-200'] < 218.9604) | ((df['RR 600-1200'] > 543.48734)), ('F9')] = 0


features = [ 'F1', 'F3', 'F4', 'F5', 'F7', 'F8', 'F9' ]
