...
# HR ≥ -1.778 * Age + 198
df.loc[df['HR'] >= -1.778 * df['Age'] + 198, ('F1')] = 1
df.loc[df['HR'] < -1.778 * df['Age'] + 198, ('F1')] = 0

# EOS ≤ 0.039 * Age - 2
df.loc[df['EOS'] <= 0.039 * df['Age'] - 2, ('F2')] = 1
df.loc[df['EOS'] > 0.039 * df['Age'] - 2, ('F2')] = 0

# EF LV ≤ 0.667 * HR - 4.28
df.loc[df['EF LV'] <= 0.667 * df['HR'] - 4.28, ('F3')] = 1
df.loc[df['EF LV'] > 0.667 * df['HR'] - 4.28, ('F3')] = 0

# Glu ≥ -0.098 * HR + 14.84
df.loc[df['Glu'] >= -0.098 * df['HR'] + 14.84, ('F4')] = 1
df.loc[df['Glu'] < -0.098 * df['HR'] + 14.84, ('F4')] = 0

# SBP ≤ 60 * Killip + 12.9
df.loc[df['SBP'] <= 60 * df['Killip class'] + 12.9, ('F5')] = 1
df.loc[df['SBP'] > 60 * df['Killip class'] + 12.9, ('F5')] = 0

# EF LV ≤ 0.21 * Creatinine + 25.25
df.loc[df['EF LV'] <= 0.21 * df['Cr'] + 25.25, ('F6')] = 1
df.loc[df['EF LV'] > 0.21 * df['Cr'] + 25.25, ('F6')] = 0

# SBP ≤ 0.963 * Creatinine - 0.423
df.loc[df['SBP'] <= 0.963 * df['Cr'] - 0.423, ('F7')] = 1
df.loc[df['SBP'] > 0.963 * df['Cr'] - 0.423, ('F7')] = 0

# PCT ≥ 0.027 * EF LV - 1.139
df.loc[df['PCT'] >= 0.027 * df['EF LV'] - 1.139, ('F8')] = 1
df.loc[df['PCT'] < 0.027 * df['EF LV'] - 1.139, ('F8')] = 0

# SBP ≤ 10.1 * NEUT - 646.8
df.loc[df['SBP'] <= 10.1 * df['NEUT'] - 646.8, ('F9')] = 1
df.loc[df['SBP'] > 10.1 * df['NEUT'] - 646.8, ('F9')] = 0

# Glu ≥ -4.13 * PCT + 7.56
df.loc[df['Glu'] >= -4.13 * df['PCT'] + 7.56, ('F10')] = 1
df.loc[df['Glu'] < -4.13 * df['PCT'] + 7.56, ('F10')] = 0
