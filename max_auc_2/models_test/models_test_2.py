...
df.loc[(df['HR'] >= 85.1924) & ((df['NEUT'] >= 75.6539) |
                                (df['EOS'] <= 0.905011)), ('F2')] = 1
df.loc[(df['HR'] < 85.1924) | ((df['NEUT'] < 75.6539) &
                                (df['EOS'] > 0.905011)), ('F2')] = 0
...
df.loc[(df['EOS'] <= 0.905011) & ((df['NEUT'] >= 75.653) |
                                  (df['PCT'] >= 0.3712) |
                                  (df['SBP'] <= 102.6611)), ('F6')] = 1
df.loc[(df['EOS'] > 0.905011) | ((df['NEUT'] < 75.653) &
                                  (df['PCT'] < 0.3712) &
                                 (df['SBP'] > 102.6611)), ('F6')] = 0


df.loc[(df['Glu'] >= 10.42821) & (df['NEUT'] >= 75.653), ('F7')] = 1
df.loc[(df['Glu'] < 10.42821) | (df['NEUT'] < 75.653), ('F7')] = 0
