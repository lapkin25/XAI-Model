...
# Возраст ≥57.7
# NER1 ≥42.69777432712215
df.loc[(df['Возраст'] >= 57.7) & (df['NER1'] >= 42.69777432712215), ('F1')] = 1
df.loc[(df['Возраст'] < 57.7) | (df['NER1'] < 42.69777432712215), ('F1')] = 0

#   Возраст ≥66.0
#   интервал PQ 120-200 ≤202.0
df.loc[(df['Возраст'] >= 66.0) & (df['интервал PQ 120-200'] <= 202.0), ('F2')] = 1
df.loc[(df['Возраст'] < 66.0) | (df['интервал PQ 120-200'] > 202.0), ('F2')] = 0

# NER1 ≥48.92500000000007
# СОЭ ≥11.499999999999998
df.loc[(df['NER1'] >= 48.92500000000007) & (df['СОЭ'] >= 11.499999999999998), ('F3')] = 1
df.loc[(df['NER1'] < 48.92500000000007) | (df['СОЭ'] < 11.499999999999998), ('F3')] = 0

#   NER1 ≥53.47409090909093
#   СДЛА ≥25.200000000000003
df.loc[(df['NER1'] >= 53.47409090909093) & (df['СДЛА'] >= 25.200000000000003), ('F4')] = 1
df.loc[(df['NER1'] < 53.47409090909093) | (df['СДЛА'] < 25.200000000000003), ('F4')] = 0

# SIRI ≥5.105720833333333
# RR 600-1200 ≥454.00000000000006
df.loc[(df['SIRI'] >= 5.105720833333333) & (df['RR 600-1200'] >= 454.00000000000006), ('F5')] = 1
df.loc[(df['SIRI'] < 5.105720833333333) | (df['RR 600-1200'] < 454.00000000000006), ('F5')] = 0

#   TIMI после ≤2.0
#   интервал PQ 120-200 ≤199.0
df.loc[(df['TIMI после'] <= 2.0) & (df['интервал PQ 120-200'] <= 199.0), ('F6')] = 1
df.loc[(df['TIMI после'] > 2.0) | (df['интервал PQ 120-200'] > 199.0), ('F6')] = 0

#   TIMI после ≤2.0
#   RR 600-1200_ ≤796.0
df.loc[(df['TIMI после'] <= 2.0) & (df['RR 600-1200'] <= 796.0), ('F7')] = 1
df.loc[(df['TIMI после'] > 2.0) | (df['RR 600-1200'] > 796.0), ('F7')] = 0

#   СДЛА ≥33.1
#   интервал PQ 120-200 ≤198.0
df.loc[(df['СДЛА'] >= 33.1) & (df['интервал PQ 120-200'] <= 198.0), ('F8')] = 1
df.loc[(df['СДЛА'] < 33.1) | (df['интервал PQ 120-200'] > 198.0), ('F8')] = 0

#   Killip ≥2.4
#   RR 600-1200 ≥448.00000000000006
df.loc[(df['Killip'] >= 2.4) & (df['RR 600-1200'] >= 448.00000000000006), ('F9')] = 1
df.loc[(df['Killip'] < 2.4) | (df['RR 600-1200'] < 448.00000000000006), ('F9')] = 0
