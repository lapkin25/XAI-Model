...
"""
EOS ≤0.3441233258087948
Glu ≥8.119903567394266
HR ≥82.88558088282593
Killip class ≥2.965631730770588
SBP ≤106.2869288574362
(EOS & Glu) | (EOS & HR) | (EOS & Killip_class) | (EOS & SBP) | (Glu & HR)
"""

df.loc[((df['EOS'] <= 0.344) & (df['Glu'] >= 8.119)) |
       ((df['EOS'] <= 0.344) & (df['HR'] >= 82.88)) |
       ((df['EOS'] <= 0.344) & (df['Killip class'] >= 2.965)) |
       ((df['EOS'] <= 0.344) & (df['SBP'] <= 106.28)) |
       ((df['Glu'] >= 8.1199) & (df['HR'] >= 82.88)), ('F1')] = 1
df.loc[((df['EOS'] > 0.344) | (df['Glu'] < 8.119)) &
       ((df['EOS'] > 0.344) | (df['HR'] < 82.88)) &
       ((df['EOS'] > 0.344) | (df['Killip class'] < 2.965)) &
       ((df['EOS'] > 0.344) | (df['SBP'] > 106.28)) &
       ((df['Glu'] < 8.1199) | (df['HR'] < 82.88)), ('F1')] = 0

"""
Age ≥63.44249482534901
Cr ≥171.49408052050413
Killip class ≥2.964171685095616
NEUT ≥74.89987194725678
PCT ≥0.31010315615292733
Age & NEUT
"""

df.loc[((df['Age'] >= 63.44) & (df['NEUT'] >= 74.89)), ('F2')] = 1
df.loc[((df['Age'] < 63.44) | (df['NEUT'] < 74.89)), ('F2')] = 0

"""
Age ≥70.2512022836382
Cr ≥157.32040321874103
EF LV ≤50.35806979175839
EOS ≤0.48379897902481395
Glu ≥6.307939381779703
Killip class ≥2.9591370192061532
(Age & EOS & Glu) | (Cr & EOS & Glu) | (EF_LV & EOS & Glu) | (EOS & Glu & Killip_class)
"""

df.loc[((df['Age'] >= 70.2) & (df['EOS'] <= 0.4837) & (df['Glu'] >= 6.307)) |
       ((df['Cr'] >= 157.320) & (df['EOS'] <= 0.4837) & (df['Glu'] >= 6.307)) |
       ((df['EF LV'] <= 50.358) & (df['EOS'] <= 0.4837) & (df['Glu'] >= 6.307)) |
       ((df['EOS'] <= 0.4837) & (df['Glu'] >= 6.307) & (df['Killip class'] >= 2.9591)), ('F3')] = 1
df.loc[((df['Age'] < 70.2) | (df['EOS'] > 0.4837) | (df['Glu'] < 6.307)) &
       ((df['Cr'] < 157.320) | (df['EOS'] > 0.4837) | (df['Glu'] < 6.307)) &
       ((df['EF LV'] > 50.358) | (df['EOS'] > 0.4837) | (df['Glu'] < 6.307)) &
       ((df['EOS'] > 0.4837) | (df['Glu'] < 6.307) | (df['Killip class'] < 2.9591)), ('F3')] = 0


"""
Age ≥66.28661457091063
Cr ≥138.21166466284743
EF LV ≤37.860175473901165
HR ≥76.46420594542089
NEUT ≥74.32883788386648
SBP ≤126.32950436273494
(Age & Cr & SBP) | (Age & EF_LV & NEUT) | (Age & HR & NEUT) | (Age & NEUT & SBP) | (Cr & NEUT & SBP) | (EF_LV & HR & NEUT) | (HR & NEUT & SBP)
"""

df.loc[((df['Age'] >= 66.28) & (df['Cr'] >= 138.21) & (df['SBP'] <= 126.329)) |
       ((df['Age'] >= 66.28) & (df['EF LV'] <= 37.860) & (df['NEUT'] >= 74.32)) |
       ((df['Age'] >= 66.28) & (df['HR'] >= 76.464) & (df['NEUT'] >= 74.32)) |
       ((df['Age'] >= 66.28) & (df['NEUT'] >= 74.32) & (df['SBP'] <= 126.329)) |
       ((df['Cr'] >= 138.21) & (df['NEUT'] >= 74.32) & (df['SBP'] <= 126.329)) |
       ((df['EF LV'] <= 37.860) & (df['HR'] >= 76.464) & (df['NEUT'] >= 74.32)) |
       ((df['HR'] >= 76.464) & (df['NEUT'] >= 74.32) & (df['SBP'] <= 126.329)), ('F4')] = 1
df.loc[((df['Age'] < 66.28) | (df['Cr'] < 138.21) | (df['SBP'] > 126.329)) &
       ((df['Age'] < 66.28) | (df['EF LV'] > 37.860) | (df['NEUT'] < 74.32)) &
       ((df['Age'] < 66.28) | (df['HR'] < 76.464) | (df['NEUT'] < 74.32)) &
       ((df['Age'] < 66.28) | (df['NEUT'] < 74.32) | (df['SBP'] > 126.329)) &
       ((df['Cr'] < 138.21) | (df['NEUT'] < 74.32) | (df['SBP'] > 126.329)) &
       ((df['EF LV'] > 37.860) | (df['HR'] < 76.464) | (df['NEUT'] < 74.32)) &
       ((df['HR'] < 76.464) | (df['NEUT'] < 74.32) | (df['SBP'] > 126.329)), ('F4')] = 0


"""
EF LV ≤50.05023204253116
EOS ≤0.2879799205235174
HR ≥77.6001009077297
Killip class ≥2.9566171761609583
NEUT ≥74.08718263557654
SBP ≤132.01995368151043
 (EF_LV & EOS & NEUT) | (EF_LV & HR & NEUT) | (Killip_class & NEUT & SBP)
"""
df.loc[((df['EF LV'] <= 50.0502) & (df['EOS'] <= 0.2879) & (df['NEUT'] >= 74.087)) |
       ((df['EF LV'] <= 50.0502) & (df['HR'] >= 77.60) & (df['NEUT'] >= 74.087)) |
       ((df['Killip class'] >= 2.95661) & (df['NEUT'] >= 74.087) & (df['SBP'] <= 132.019)), ('F5')] = 1
df.loc[((df['EF LV'] > 50.0502) | (df['EOS'] > 0.2879) | (df['NEUT'] < 74.087)) &
       ((df['EF LV'] > 50.0502) | (df['HR'] < 77.60) | (df['NEUT'] < 74.087)) &
       ((df['Killip class'] < 2.95661) | (df['NEUT'] < 74.087) | (df['SBP'] > 132.019)), ('F5')] = 0
