...
df.loc[(df['Killip class'] >= 3), ('F4')] = 1
df.loc[(df['Killip class'] < 3), ('F4')] = 0

df.loc[(df['PCT'] >= 0.36), ('F5')] = 1
df.loc[(df['PCT'] < 0.36), ('F5')] = 0

df.loc[(df['Age'] >= 74), ('F6')] = 1
df.loc[(df['Age'] < 74), ('F6')] = 0

df.loc[(df['SBP'] >= 113), ('F7')] = 1
df.loc[(df['SBP'] < 113), ('F7')] = 0
