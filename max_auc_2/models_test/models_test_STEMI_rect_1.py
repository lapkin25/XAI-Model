...
#   Возраст ≥64.6
#   СДЛА ≥25.1
df.loc[(df['Возраст'] >= 64.6) & (df['СДЛА'] >= 25.1), ('F1')] = 1
df.loc[(df['Возраст'] < 64.6) | (df['СДЛА'] < 25.1), ('F1')] = 0
"""

#   Возраст ≥64.8
#   Killip ≥1.0
df.loc[(df['Возраст'] >= 64.8), ('F1')] = 1
df.loc[(df['Возраст'] < 64.8), ('F1')] = 0

#   NER1 ≥48.92500000000007
#   СОЭ ≥11.499999999999998
df.loc[(df['NER1'] >= 48.925) & (df['СОЭ'] >= 11.499), ('F2')] = 1
df.loc[(df['NER1'] < 48.925) | (df['СОЭ'] < 11.499), ('F2')] = 0

#   NER1 ≥53.47409090909093
#   СДЛА ≥25.200000000000003
df.loc[(df['NER1'] >= 53.474090909) & (df['СДЛА'] >= 25.2), ('F3')] = 1
df.loc[(df['NER1'] < 53.474090909) | (df['СДЛА'] < 25.2), ('F3')] = 0

#   SIRI ≥2.815959821263025
#   TIMI после ≤2.0
df.loc[(df['SIRI'] >= 2.8159) & (df['TIMI после'] <= 2.0), ('F4')] = 1
df.loc[(df['SIRI'] < 2.8159) | (df['TIMI после'] > 2.0), ('F4')] = 0

#   SIRI ≥4.625897044787077
df.loc[(df['SIRI'] >= 4.625897), ('F5')] = 1
df.loc[(df['SIRI'] < 4.625897), ('F5')] = 0

#   СОЭ ≥25.3
#   СДЛА ≥24.400000000000002
df.loc[(df['СОЭ'] >= 25.3) & (df['СДЛА'] >= 24.4), ('F6')] = 1
df.loc[(df['СОЭ'] < 25.3) | (df['СДЛА'] < 24.4), ('F6')] = 0

#   СОЭ ≥28.1
#   интервал PQ 120-200 ≤120.0
df.loc[(df['СОЭ'] >= 28.1) & (df['интервал PQ 120-200'] <= 120), ('F7')] = 1
df.loc[(df['СОЭ'] < 28.1) | (df['интервал PQ 120-200'] > 120), ('F7')] = 0

#   СОЭ ≥9.9
#   RR 600-1200_ ≤595.0
df.loc[(df['СОЭ'] >= 9.9) & (df['RR 600-1200'] <= 595.0), ('F8')] = 1
df.loc[(df['СОЭ'] < 9.9) | (df['RR 600-1200'] > 595.0), ('F8')] = 0
