...
# Возраст ≥59.0
#   NER1 ≥43.60000000000002
df.loc[(df['Возраст'] >= 59.0) & (df['NER1'] >= 43.60000000000002), ('F1')] = 1
df.loc[(df['Возраст'] < 59.0) | (df['NER1'] < 43.60000000000002), ('F1')] = 0

#   Возраст ≥64.2
#   СДЛА ≥25.2
df.loc[(df['Возраст'] >= 64.2) & (df['СДЛА'] >= 25.2), ('F2')] = 1
df.loc[(df['Возраст'] < 64.2) | (df['СДЛА'] < 25.2), ('F2')] = 0

#   Возраст ≥57.8
#   RR 600-1200 ≤597.6
df.loc[(df['Возраст'] >= 57.8) & (df['RR 600-1200'] <= 597.6), ('F3')] = 1
df.loc[(df['Возраст'] < 57.8) | (df['RR 600-1200'] > 597.6), ('F3')] = 0

# NER1 ≥49.10000000000002
#   СОЭ ≥15.0
df.loc[(df['NER1'] >= 49.10000000000002) & (df['СОЭ'] >= 15.0), ('F4')] = 1
df.loc[(df['NER1'] < 49.10000000000002) | (df['СОЭ'] < 15.0), ('F4')] = 0

# NER1 ≥51.379999999999995
#   СДЛА ≥25.0
df.loc[(df['NER1'] >= 51.379999999999995) & (df['СДЛА'] >= 25.0), ('F5')] = 1
df.loc[(df['NER1'] < 51.379999999999995) | (df['СДЛА'] < 25.0), ('F5')] = 0

# SIRI ≥3.597711721733971
#   TIMI после ≤2.0
df.loc[(df['SIRI'] >= 3.597711) & (df['TIMI после'] <= 2.0), ('F6')] = 1
df.loc[(df['SIRI'] < 3.597711) | (df['TIMI после'] > 2.0), ('F6')] = 0

#  SIRI ≥4.731617878120411
#   СДЛА ≥22.200000000000003
df.loc[(df['SIRI'] >= 4.73161) & (df['СДЛА'] >= 22.200000000000003), ('F7')] = 1
df.loc[(df['SIRI'] < 4.73161) | (df['СДЛА'] < 22.200000000000003), ('F7')] = 0

# RR 600-1200 ≤592.0
#   интервал PQ 120-200 ≥204.0
df.loc[(df['RR 600-1200'] <= 592.0) & (df['интервал PQ 120-200'] >= 204.0), ('F8')] = 1
df.loc[(df['RR 600-1200'] > 592.0) | (df['интервал PQ 120-200'] < 204.0), ('F8')] = 0
