...
# Фенотипы:
# Age & (NEUT [ 75.34800000000001 ] | EF LV [ 46.8 ])
# HR & (EOS [ 0.39 ] | Killip class [ 3.0 ] | NEUT [ 77.28 ])
# Killip class & (NEUT [ 74.382 ] | HR [ 83.5 ] | Cr [ 133.51 ])
# Cr & (NEUT [ 75.34800000000001 ] | EF LV [ 46.8 ] | EOS [ 0.39 ] | PCT [ 0.292 ])
# EF LV & (EOS [ 0.39 ] | Killip class [ 3.0 ] | NEUT [ 79.212 ])
# NEUT & (Glu [ 6.9056 ] | Age [ 70.68 ] | EF LV [ 46.8 ])
# EOS & (NEUT [ 75.34800000000001 ] | Age [ 70.68 ])
# PCT & (NEUT [ 81.144 ] | HR [ 86.3 ])
# Glu & (NEUT [ 75.34800000000001 ] | Age [ 70.68 ])
# SBP & (NEUT [ 75.34800000000001 ] | EF LV [ 46.8 ])



# Age & (NEUT [ 75.34800000000001 ] | EF LV [ 46.8 ])
df.loc[(df['Age'] >= 50.22) & ((df['NEUT'] >= 75.34800)
                                | (df['EF LV'] <= 46.8)), ('F1')] = 1
df.loc[(df['Age'] < 50.22) | ((df['NEUT'] < 75.34800)
                                & (df['EF LV'] > 46.8)), ('F1')] = 0

# HR & (EOS [ 0.39 ] | Killip class [ 3.0 ] | NEUT [ 77.28 ])
df.loc[(df['HR'] >= 80.0) & ((df['EOS'] <= 0.39) |
                             (df['Killip class'] >= 3.0) |
                             (df['NEUT'] >= 77.28)), ('F2')] = 1
df.loc[(df['HR'] < 80.0) | ((df['EOS'] > 0.39) &
                             (df['Killip class'] < 3.0) &
...
# Killip class & (NEUT [ 74.382 ] | HR [ 83.5 ] | Cr [ 133.51 ])
df.loc[(df['Killip class'] >= 3.0) & ((df['NEUT'] >= 74.382) |
                                      (df['HR'] >= 83.5) |
                                      (df['Cr'] >= 133.51)), ('F3')] = 1
df.loc[(df['Killip class'] < 3.0) | ((df['NEUT'] < 74.382) &
                                      (df['HR'] < 83.5) &
...
# Cr & (NEUT [ 75.34800000000001 ] | EF LV [ 46.8 ] | EOS [ 0.39 ] | PCT [ 0.292 ])
df.loc[(df['Cr'] >= 115.0) & ((df['NEUT'] >= 75.348000) |
                              (df['EF LV'] <= 46.8) |
                              (df['EOS'] <= 0.39) |
                              (df['PCT'] >= 0.292)), ('F4')] = 1
df.loc[(df['Cr'] < 115.0) | ((df['NEUT'] < 75.348000) &
...
# EF LV & (EOS [ 0.39 ] | Killip class [ 3.0 ] | NEUT [ 79.212 ])
df.loc[(df['EF LV'] <= 50.0) & ((df['EOS'] <= 0.39) |
                                (df['Killip class'] >= 3.0) |
                                (df['NEUT'] >= 79.212)), ('F5')] = 1
df.loc[(df['EF LV'] > 50.0) | ((df['EOS'] > 0.39) &
                                (df['Killip class'] < 3.0) &
...
# NEUT & (Glu [ 6.9056 ] | Age [ 70.68 ] | EF LV [ 46.8 ])
df.loc[(df['NEUT'] >= 67.62) & ((df['Glu'] >= 6.9056) |
                                (df['Age'] >= 70.68) |
                                (df['EF LV'] <= 46.8)), ('F6')] = 1
df.loc[(df['NEUT'] < 67.62) | ((df['Glu'] < 6.9056) &
                                (df['Age'] < 70.68) &
...
# EOS & (NEUT [ 75.34800000000001 ] | Age [ 70.68 ])
df.loc[(df['EOS'] <= 0.99) & ((df['NEUT'] >= 75.348) |
                              (df['Age'] >= 70.68)), ('F7')] = 1
df.loc[(df['EOS'] > 0.99) | ((df['NEUT'] < 75.348) &
                              (df['Age'] < 70.68)), ('F7')] = 0

# PCT & (NEUT [ 81.144 ] | HR [ 86.3 ])
df.loc[(df['PCT'] >= 0.257) & ((df['NEUT'] >= 81.144) |
                               (df['HR'] >= 86.3)), ('F8')] = 1
df.loc[(df['PCT'] < 0.257) | ((df['NEUT'] < 81.144) &
                               (df['HR'] < 86.3)), ('F8')] = 0

# Glu & (NEUT [ 75.34800000000001 ] | Age [ 70.68 ])
df.loc[(df['Glu'] >= 6.2528) & ((df['NEUT'] >= 75.3480) |
                                  (df['Age'] >= 70.68)), ('F9')] = 1
df.loc[(df['Glu'] < 6.2528) | ((df['NEUT'] < 75.3480) &
                                  (df['Age'] < 70.68)), ('F9')] = 0

# SBP & (NEUT [ 75.34800000000001 ] | EF LV [ 46.8 ])
df.loc[(df['SBP'] <= 115.0) & ((df['NEUT'] >= 75.34800000000001) |
                               (df['EF LV'] <= 46.8)), ('F10')] = 1
df.loc[(df['SBP'] > 115.0) | ((df['NEUT'] < 75.34800000000001) &
                               (df['EF LV'] > 46.8)), ('F10')] = 0
