...
#SIRI ≥ -0.22142912875762788 * NER1 + 15.083793191794145
df.loc[(df['SIRI'] >= -0.2214291 * df['NER1'] + 15.083793), ('F11')] = 1
df.loc[(df['SIRI'] < -0.2214291 * df['NER1'] + 15.083793), ('F11')] = 0
...
"""
#СОЭ ≥ -1.4868320722442998 * Возраст + 121.26085586837232
df.loc[(df['СОЭ'] >= -1.486832 * df['Возраст'] + 121.26085), ('F13')] = 1
df.loc[(df['СОЭ'] < -1.486832 * df['Возраст'] + 121.26085), ('F13')] = 0
"""
...
#NBR1 ≥ -0.35776213013593533 * СОЭ + 12.35176058346235
df.loc[(df['NBR1'] >= -0.3577621301 * df['СОЭ'] + 12.351760), ('F12')] = 1
df.loc[(df['NBR1'] < -0.3577621301 * df['СОЭ'] + 12.351760), ('F12')] = 0

#NBR1 ≥ -0.0001536490580051085 * RR 600-1200 + 4.932215848301049
df.loc[(df['NBR1'] >= -0.00015364905 * df['RR 600-1200'] + 4.93221), ('F13')] = 1
df.loc[(df['NBR1'] < -0.00015364905 * df['RR 600-1200'] + 4.93221), ('F13')] = 0

#SII ≥ 2.715151528547957 * RR 600-1200 + -1246.174475846814
df.loc[(df['SII'] >= 2.715151528 * df['RR 600-1200'] - 1246.1744), ('F14')] = 1
df.loc[(df['SII'] < 2.715151528 * df['RR 600-1200'] - 1246.1744), ('F14')] = 0

#NBR1 ≥ -0.43859963736054436 * Возраст + 32.00835921818352
df.loc[(df['NBR1'] >= -0.438599 * df['Возраст'] + 32.008359), ('F15')] = 1
df.loc[(df['NBR1'] < -0.438599 * df['Возраст'] + 32.008359), ('F15')] = 0
...
"""
#SIRI ≥ -0.22142912875762788 * NER1 + 15.083793191794145
df.loc[(df['SIRI'] >= -0.221429 * df['NER1'] + 15.0837931), ('F1')] = 1
df.loc[(df['SIRI'] < -0.221429 * df['NER1'] + 15.0837931), ('F1')] = 0

#СОЭ ≥ -0.39859952045212765 * NER1 + 60.608313005810885
df.loc[(df['СОЭ'] >= -0.39859952 * df['NER1'] + 60.608313005), ('F2')] = 1
df.loc[(df['СОЭ'] < -0.39859952 * df['NER1'] + 60.608313005), ('F2')] = 0

#СДЛА ≥ -0.4028012645884141 * NER1 + 59.40704427993998
df.loc[(df['СДЛА'] >= -0.402801 * df['NER1'] + 59.4070442), ('F3')] = 1
df.loc[(df['СДЛА'] < -0.402801 * df['NER1'] + 59.4070442), ('F3')] = 0

#RR 600-1200 ≤ 11.073460764963347 * NER1 + 126.2306970967876
df.loc[(df['RR 600-1200'] <= 11.0734607 * df['NER1'] + 126.230697), ('F4')] = 1
df.loc[(df['RR 600-1200'] > 11.0734607 * df['NER1'] + 126.230697), ('F4')] = 0

#интервал PQ 120-200 ≥ -0.9050570973303409 * NER1 + 223.28894311455548
df.loc[(df['интервал PQ 120-200'] >= -0.90505709 * df['NER1'] + 223.288943), ('F5')] = 1
df.loc[(df['интервал PQ 120-200'] < -0.90505709 * df['NER1'] + 223.288943), ('F5')] = 0

#TIMI после ≤ 0.35859346932350905 * SIRI + 1.1320607341194353
df.loc[(df['TIMI после'] <= 0.358593 * df['SIRI'] + 1.1320607), ('F6')] = 1
df.loc[(df['TIMI после'] > 0.358593 * df['SIRI'] + 1.1320607), ('F6')] = 0

#СДЛА ≥ -2.091772956037363 * SIRI + 38.63205427239542
df.loc[(df['СДЛА'] >= -2.091772 * df['SIRI'] + 38.63205), ('F7')] = 1
df.loc[(df['СДЛА'] < -2.091772 * df['SIRI'] + 38.63205), ('F7')] = 0

#RR 600-1200 ≤ 118.1413395515572 * SIRI + 254.21849842691566
df.loc[(df['RR 600-1200'] <= 118.141339 * df['SIRI'] + 254.2184984), ('F8')] = 1
df.loc[(df['RR 600-1200'] > 118.141339 * df['SIRI'] + 254.2184984), ('F8')] = 0

#интервал PQ 120-200 ≤ 16.906383455999215 * SIRI + 92.2383613715617
df.loc[(df['интервал PQ 120-200'] <= 16.9063834 * df['SIRI'] + 92.238361), ('F9')] = 1
df.loc[(df['интервал PQ 120-200'] > 16.9063834 * df['SIRI'] + 92.238361), ('F9')] = 0

#Возраст ≥ -2.312549664930434 * SIRI + 73.07455684085589
df.loc[(df['Возраст'] >= -2.31254966 * df['SIRI'] + 73.0745568), ('F10')] = 1
df.loc[(df['Возраст'] < -2.31254966 * df['SIRI'] + 73.0745568), ('F10')] = 0

#СДЛА ≥ -0.6994272850439975 * СОЭ + 50.39689141452437
df.loc[(df['СДЛА'] >= -0.6994272 * df['СОЭ'] + 50.3968914), ('F11')] = 1
df.loc[(df['СДЛА'] < -0.6994272 * df['СОЭ'] + 50.3968914), ('F11')] = 0

#RR 600-1200 ≤ 11.059113681882991 * СОЭ + 476.1922062994142
df.loc[(df['RR 600-1200'] <= 11.0591136 * df['СОЭ'] + 476.192206), ('F12')] = 1
df.loc[(df['RR 600-1200'] > 11.0591136 * df['СОЭ'] + 476.192206), ('F12')] = 0

#интервал PQ 120-200 ≤ 6.990229316303869 * СОЭ + -33.99949272780614
df.loc[(df['интервал PQ 120-200'] <= 6.990229316 * df['СОЭ'] - 33.999492), ('F13')] = 1
df.loc[(df['интервал PQ 120-200'] > 6.990229316 * df['СОЭ'] - 33.999492), ('F13')] = 0

#Возраст ≥ -0.7104405835822577 * СОЭ + 82.55776444835963
df.loc[(df['Возраст'] >= -0.71044058 * df['СОЭ'] + 82.557764), ('F14')] = 1
df.loc[(df['Возраст'] < -0.71044058 * df['СОЭ'] + 82.557764), ('F14')] = 0

#Возраст ≥ 37.76549190084298 * TIMI после + -47.29647570252895
df.loc[(df['Возраст'] >= 37.765491 * df['TIMI после'] - 47.296475), ('F15')] = 1
df.loc[(df['Возраст'] < 37.765491 * df['TIMI после'] - 47.296475), ('F15')] = 0

#интервал PQ 120-200 ≤ 11.136815945190111 * СДЛА + -173.92538155262497
df.loc[(df['интервал PQ 120-200'] <= 11.1368159 * df['СДЛА'] - 173.92538155), ('F16')] = 1
df.loc[(df['интервал PQ 120-200'] > 11.1368159 * df['СДЛА'] - 173.92538155), ('F16')] = 0

#интервал PQ 120-200 ≤ -0.7916263996654761 * RR 600-1200 + 758.2044950465131
df.loc[(df['интервал PQ 120-200'] <= -0.7916263996 * df['RR 600-1200'] + 758.20449), ('F17')] = 1
df.loc[(df['интервал PQ 120-200'] > -0.7916263996 * df['RR 600-1200'] + 758.20449), ('F17')] = 0

#Возраст ≥ 0.1272569961285119 * интервал PQ 120-200 + 44.83728327680323
df.loc[(df['Возраст'] >= 0.12725699 * df['интервал PQ 120-200'] + 44.837283), ('F18')] = 1
df.loc[(df['Возраст'] < 0.12725699 * df['интервал PQ 120-200'] + 44.837283), ('F18')] = 0

#Killip ≥ -0.2436123351152282 * Возраст + 17.184905596452044
df.loc[(df['Killip'] >= -0.2436123351 * df['Возраст'] + 17.1849055964), ('F19')] = 1
df.loc[(df['Killip'] < -0.2436123351 * df['Возраст'] + 17.1849055964), ('F19')] = 0
"""



features =[ 'F1', 'F2', 'F4', 'F5', 'F7', 'F10', 'F11', 'F12'
