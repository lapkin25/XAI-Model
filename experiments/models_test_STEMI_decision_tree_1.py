...
df.loc[:, ('F1')] = 0
df.loc[(df['RR 600-1200'] > 1370), ('F1')] = 1

df.loc[:, ('F2')] = 0
df.loc[(df['RR 600-1200'] < 1370) & (df['СОЭ'] > 38.5) & (df['Возраст'] < 48.5), ('F2')] = 1

df.loc[:, ('F3')] = 0
df.loc[(df['СОЭ'] < 38.5) & (df['TIMI после'] <= 2) & (df['RR 600-1200'] < 660) & (df['NER1'] > 491.9), ('F3')] = 1
