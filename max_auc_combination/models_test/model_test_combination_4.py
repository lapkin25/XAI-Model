...
df.loc[((df['EF LV'] <= 40) & (df['EOS'] <= 0.3)) |
       ((df['EF LV'] <= 40) & (df['HR'] >= 84)) |
       ((df['EF LV'] <= 40) & (df['Glu'] >= 7.2)) |
       ((df['EOS'] <= 0.3) & (df['HR'] >= 84)) |
       ((df['EOS'] <= 0.3) & (df['Glu'] >= 7.2)) |
       ((df['HR'] >= 84) & (df['Glu'] >= 7.2)), ('F1')] = 1
df.loc[((df['EF LV'] > 40) | (df['EOS'] > 0.3)) &
       ((df['EF LV'] > 40) | (df['HR'] < 84)) &
       ((df['EF LV'] > 40) | (df['Glu'] < 7.2)) &
       ((df['EOS'] > 0.3) | (df['HR'] < 84)) &
       ((df['EOS'] > 0.3) | (df['Glu'] < 7.2)) &
       ((df['HR'] < 84) | (df['Glu'] < 7.2)), ('F1')] = 0


df.loc[((df['EOS'] <= 0.18) & (df['Age'] >= 64)) |
       ((df['EOS'] <= 0.18) & (df['NEUT'] >= 74.6)) |
       ((df['Age'] >= 64) & (df['NEUT'] >= 74.6)), ('F2')] = 1
df.loc[((df['EOS'] > 0.18) | (df['Age'] < 64)) &
       ((df['EOS'] > 0.18) | (df['NEUT'] < 74.6)) &
       ((df['Age'] < 64) | (df['NEUT'] < 74.6)), ('F2')] = 0

#df.loc[(df['Age'] >= 74) | (df['Cr'] >= 174) | (df['Killip class'] >= 3) | (df['PCT'] >= 0.36), ('F3')] = 1
#df.loc[(df['Age'] < 74) & (df['Cr'] < 174) & (df['Killip class'] < 3) & (df['PCT'] < 0.36), ('F3')] = 0

df.loc[(df['Cr'] >= 174), ('F3')] = 1
df.loc[(df['Cr'] < 174), ('F3')] = 0

df.loc[((df['Age'] >= 70) & (df['Glu'] >= 7.2)) |
       ((df['Age'] >= 70) & (df['Killip class'] >= 3)) |
       ((df['Age'] >= 70) & (df['SBP'] <= 117)) |
       ((df['Glu'] >= 7.2) & (df['Killip class'] >= 3)) |
       ((df['Glu'] >= 7.2) & (df['PCT'] >= 0.28)) |
       ((df['Glu'] >= 7.2) & (df['SBP'] <= 117)) |
       ((df['Killip class'] >= 3) & (df['PCT'] >= 0.28)) |
       ((df['Killip class'] >= 3) & (df['SBP'] <= 117)), ('F4')] = 1
df.loc[((df['Age'] < 70) | (df['Glu'] < 7.2)) &
       ((df['Age'] < 70) | (df['Killip class'] < 3)) &
       ((df['Age'] < 70) | (df['SBP'] > 117)) &
       ((df['Glu'] < 7.2) | (df['Killip class'] < 3)) &
       ...
       ((df['Glu'] < 7.2) | (df['SBP'] > 117)) &
       ((df['Killip class'] < 3) | (df['PCT'] < 0.28)) &
       ((df['Killip class'] < 3) | (df['SBP'] > 117)), ('F4')] = 0

df.loc[(df['Killip class'] >= 3), ('F5')] = 1
df.loc[(df['Killip class'] < 3), ('F5')] = 0

df.loc[(df['PCT'] >= 0.36), ('F6')] = 1
df.loc[(df['PCT'] < 0.36), ('F6')] = 0

df.loc[(df['Age'] >= 74), ('F7')] = 1
df.loc[(df['Age'] < 74), ('F7')] = 0

df.loc[(df['SBP'] >= 113), ('F8')] = 1
df.loc[(df['SBP'] < 113), ('F8')] = 0

df.loc[(df['HR'] >= 95), ('F9')] = 1
df.loc[(df['HR'] < 95), ('F9')] = 0

#df.loc[(df['EOS'] <= 0.26), ('F10')] = 1
#df.loc[(df['EOS'] > 0.26), ('F10')] = 0

#df.loc[(df['NEUT'] >= 75.5), ('F11')] = 1
#df.loc[(df['NEUT'] < 75.5), ('F11')] = 0

df.loc[(df['Glu'] >= 8.26), ('F12')] = 1
df.loc[(df['Glu'] < 8.26), ('F12')] = 0

df.loc[(df['EF LV'] <= 44), ('F13')] = 1
df.loc[(df['EF LV'] > 44), ('F13')] = 0

features =[ 'F1', 'F2', 'F3', 'F4', 'F5', 'F6', 'F7', 'F8', 'F9',  'F12', 'F13']
