...
df.loc[(df['SIRI'] >= 5.13), ('F1')] = 1
df.loc[(df['SIRI'] < 5.13), ('F1')] = 0

df.loc[(df['СОЭ'] >= 34), ('F2')] = 1
df.loc[(df['СОЭ'] < 34), ('F2')] = 0

df.loc[(df['СДЛА'] >= 32), ('F3')] = 1
df.loc[(df['СДЛА'] < 32), ('F3')] = 0

df.loc[(df['TIMI после'] == 3) & (df['СОЭ'] >= 34), ('F4')] = 1
df.loc[(df['TIMI после'] != 3) | (df['СОЭ'] < 34), ('F4')] = 0

df.loc[(df['Killip'] == 1) & (df['SIRI'] >= 5.13), ('F5')] = 1
df.loc[(df['Killip'] != 1) | (df['SIRI'] < 5.13), ('F5')] = 0

df.loc[(df['SIRI'] >= 5.13) & (df['СОЭ'] >= 34.0), ('F6')] = 1
df.loc[(df['SIRI'] < 5.13) | (df['СОЭ'] < 34.0), ('F6')] = 0

df.loc[(df['Killip'] == 1) & (df['СОЭ'] >= 34.0), ('F7')] = 1
df.loc[(df['Killip'] != 1) | (df['СОЭ'] < 34.0), ('F7')] = 0

df.loc[(df['NER1'] >= 258), ('F8')] = 1
df.loc[(df['NER1'] < 258), ('F8')] = 0

df.loc[(df['TIMI после'] == 3) & (df['СДЛА'] >= 32), ('F9')] = 1
df.loc[(df['TIMI после'] != 3) | (df['СДЛА'] < 32), ('F9')] = 0

df.loc[(df['NER1'] >= 258) & (df['SIRI'] >= 5.13), ('F10')] = 1
df.loc[(df['NER1'] < 258) | (df['SIRI'] < 5.13), ('F10')] = 0
