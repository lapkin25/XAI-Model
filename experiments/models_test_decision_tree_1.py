...
df.loc[:, ('F1')] = 0
df.loc[(df['EOS'] < 0.135) & (df['EF LV'] < 35.5) & (df['SBP'] < 79.5) , ('F1')] = 1

df.loc[:, ('F2')] = 0
df.loc[(df['EOS'] < 0.135) & (df['EF LV'] < 35.5) & (df['SBP'] >  79.5) & (df['Cr'] > 165) , ('F2')] = 1

df.loc[:, ('F3')] = 0
df.loc[(df['EOS'] < 0.135) & (df['EF LV'] > 35.5) & (df['SBP'] < 105.5) & (df['HR'] > 89.5) & (df['Glu'] > 8.93) , ('F3')] = 1

df.loc[:, ('F4')] = 0
df.loc[(df['EOS'] > 0.135) & (df['Glu'] > 8.635) & (df['NEUT'] < 76.45) & (df['EF LV'] < 36), ('F4')] = 1

df.loc[:, ('F5')] = 0
df.loc[(df['EOS'] > 0.135) & (df['Glu'] > 8.635) & (df['NEUT'] > 76.45) & (df['EF LV'] < 41.5) & (df['Killip class'] >= 3), ('F5')] = 1
